	            ...
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                    <div class="table-responsive">
		                    ...
		                    @endif
	                    	<form class="form-horizontal" action="admin/slide/them" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
								  	...
								  	<div class="col-md-5">
								  		<input id="slide_derc" name="slide_derc" type="text" placeholder="Mô tả" class="form-control input-md">
								  	</div>
								</div>
								<div class="form-group">
